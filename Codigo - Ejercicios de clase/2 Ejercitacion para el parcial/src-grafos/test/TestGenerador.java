...
import generadores.GrafoPGenerador;
import grafo.GrafoNDNP;
import grafo.GrafoNDP;

public class TestGenerador {	
	private static final String CARPETA_PRUEBAS = "src-grafos/LoteDePruebas/in/";
	
	@Test
	public void generarGrafoNDP() throws IOException {
		GrafoPGenerador.aleatorioConProbabilidad(10, 0.2, 10);
